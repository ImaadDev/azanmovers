export const metadata = {
  ...
  description:
    "Read the Terms of Service for Azan Packers & Movers. Understand the terms and conditions governing our moving, relocation, and packing services in Saudi Arabia.",
  keywords: [
    "terms of service",
    "service agreement",
    "terms and conditions",
    "Azan Packers & Movers",
    "Saudi Arabia moving company terms",
  ],
  robots: "index, follow",
  openGraph: {
    title: "Terms of Service – Azan Packers & Movers Saudi Arabia",
  ...
  twitter: {
    ...
    title: "Terms of Service – Azan Packers & Movers Saudi Arabia",
    description:
      "Transparent terms for all our moving services. Read the Terms of Service for Azan Packers & Movers in Saudi Arabia.",
  },
};
