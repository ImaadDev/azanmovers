...
export default function FurnitureDismantling() {
  const structuredData = {
    ...
    description: "Expert furniture dismantling and assembly to protect your belongings.",
    url: "https://www.azanmovers.com/services/furniture-dismantling",
    image: "https://www.azanmovers.com/images/furniture-dismantling.jpg" // Replace with actual image URL
  };
  ...
  return (
    <>
      <Head>
        <title>Furniture Dismantling & Assembly in Jeddah | Azan Packers & Movers</title>
        <meta
          name="description"
          content="Professional furniture dismantling and reassembly services in Jeddah. Ensure safe transport of your valuable furniture with Azan Packers & Movers."
        />
        <link rel="canonical" href="https://www.azanmovers.com/services/furniture-dismantling" />
        <meta name="robots" content="index, follow" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Furniture Dismantling & Assembly in Jeddah | Azan Packers & Movers" />
        <meta property="og:description" content="Professional furniture dismantling and reassembly services in Jeddah. Ensure safe transport of your valuable furniture with Azan Packers & Movers." />
        <meta property="og:url" content="https://www.azanmovers.com/services/furniture-dismantling" />
        <meta property="og:image" content="https://www.azanmovers.com/images/furniture-dismantling.jpg" />
        <script
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 py-16 lg:py-24">
          ...
          <header className="text-center mb-16 lg:mb-24">
            ...
            >
              ...
              furniture in Jeddah, ensuring safe transport and setup.
            </p>
          </header>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center mb-20 lg:mb-24">
            <div className="relative w-full h-80 overflow-hidden border border-white/20">
              <Image
                ...
                alt="Professional furniture dismantling and assembly services in Jeddah"
                fill
            ...
            <section className="p-8 bg-white/70 backdrop-blur-xl border border-white/20 transition-all duration-300 hover:border-red-100">
              ...
              <p className="text-sm md:text-lg leading-relaxed mb-4" style={{ color: '#6B7280' }}>
                ...
                assembly services in Jeddah. We handle all types of furniture, from
