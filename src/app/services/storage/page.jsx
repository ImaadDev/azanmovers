...
export default function StorageSolutions() {
  const structuredData = {
    ...
    image: "https://www.azanmovers.com/images/storage-solutions.jpg" // Replace with actual image URL
  };
  ...
  return (
    <>
      <Head>
        <title>Storage Solutions in Jeddah | Azan Packers & Movers</title>
        <meta
          name="description"
          content="Secure and flexible storage solutions in Jeddah for residential and commercial needs. Azan Packers & Movers offers short-term and long-term storage."
        />
        <link rel="canonical" href="https://www.azanmovers.com/services/storage" />
        <meta name="robots" content="index, follow" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Storage Solutions in Jeddah | Azan Packers & Movers" />
        <meta property="og:description" content="Secure and flexible storage solutions in Jeddah for residential and commercial needs. Azan Packers & Movers offers short-term and long-term storage." />
        <meta property="og:url" content="https://www.azanmovers.com/services/storage" />
        <meta property="og:image" content="https://www.azanmovers.com/images/storage-solutions.jpg" />
        <script
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 py-16 lg:py-24">
          ...
          <header className="text-center mb-16 lg:mb-24">
            ...
            >
              ...
              Jeddah offer the perfect solution for your belongings.
            </p>
          </header>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center mb-20 lg:mb-24">
            <div className="relative w-full h-80 overflow-hidden border border-white/20">
              <Image
                ...
                alt="Secure and flexible storage solutions in Jeddah"
                fill
            ...
            <section className="p-8 bg-white/70 backdrop-blur-xl border border-white/20 transition-all duration-300 hover:border-red-100">
              ...
              <p className="text-sm md:text-lg leading-relaxed mb-4" style={{ color: '#6B7280' }}>
                ...
                Jeddah, catering to both residential and commercial clients.
