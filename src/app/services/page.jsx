...
export default function ServicesPage() {
  const services = [
    {
      ...
      name: "House Moving",
      description:
        "Our professional house moving services in Jeddah ensure a smooth relocation. From packing and loading to transport and unpacking, we handle your belongings with utmost care.",
    ...
    },
    {
      ...
      description:
        "Minimize downtime with our reliable office relocation in Jeddah. We dismantle, pack, and move your office furniture, electronics, and documents safely and efficiently.",
    ...
    },
    {
      ...
      description:
        "Our expert movers provide safe furniture dismantling and assembly services in Jeddah. We carefully handle beds, wardrobes, desks, and fragile items to ensure safe relocation.",
  ...
  const faqs = [
    {
      id: 1,
      question: "How much do movers in Jeddah charge?",
      answer:
    ...
    },
    {
      ...
      answer: "Currently, we specialize in local moving services within Jeddah and surrounding areas. For international moves, we can recommend trusted partners.",
      category: "Coverage"
    }
  ];
  ...
  const structuredData = {
    ...
    hasOfferCatalog: {
      "@type": "OfferCatalog",
      name: "Moving Services in Jeddah",
  ...
  return (
    <>
      <Head>
        <title>Moving Services in Jeddah – Azan Packers & Movers</title>
        <meta
          name="description"
          content="Explore our moving services in Jeddah including house moving, office relocation, and furniture dismantling. Trusted packers and movers in Jeddah."
        />
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10 py-16 lg:py-24">
          ...
          <header className="text-center mb-16 lg:mb-24">
            ...
            >
              ...
              effortless, safe, and efficient in Jeddah.
            </p>
          </header>
